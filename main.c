 ...
 */
  ...
  __po_hi_driver_sockets_init (device_b_device_id);
...
/*!
 * Store the period time for task controller
 */
  __po_hi_milliseconds (&(period), 10);
  
/*!
 * \brief Making Periodic Task controller
 *
 ...
 * (sunseekercontroller_controller_k) the second is the period defined in 
 ...
 */
  __po_hi_create_periodic_task (sunseekercontroller_controller_k, &(period), __PO_HI_DEFAULT_PRIORITY, 0, controller_job);
